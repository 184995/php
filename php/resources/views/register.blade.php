...
<body>
	<div id="login-box">
		<div class="btn-list">
			<span style="opacity: .3;cursor: pointer;" class="login-opt"><a href="{{ url('/login') }}">login</a></span>
			<span style="cursor: pointer;"><a href="{{ url('/register') }}">register</a></span>
		</div>
		<input class="email" type="" name="" placeholder="email" />
